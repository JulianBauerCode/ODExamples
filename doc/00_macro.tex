...
% OPERATOREN
\newcommand{\est}{\mathrel{\hat{=}}}
\renewcommand{\d}{{\,\rm  d}}
\newcommand{\D}{{\,\rm  D}}
\newcommand{\inc}{{\,\rm  \delta}}
...
\newcommand{\hft}{\hat{\ft}}
\newcommand{\hfb}{\hat{\fb}}
...
\newcommand{\vE}{\fe}
\newcommand{\vS}{\fs}
\newcommand{\veps}{\mbox{$\underline{\varepsilon}$}}
\newcommand{\vt}{\mbox{$\underline{t}$}}
\newcommand{\vu}{\mbox{$\underline{u}$}}

%matrix
\newcommand{\mA}{\mbox{$\underline{\underline{\smash{A}}}$}}
\newcommand{\mE}{\mbox{$\underline{\underline{E}}$}}
